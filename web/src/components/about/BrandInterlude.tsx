...
/** Corner nodes that feed the wordmark, in the 320x120 viewBox. */
...
/** Traces that converge on the wordmark at (160, 114). */
...
/**
 * The one cinematic moment on the page: technical traces assemble into the
 * wordmark, then the line lands. Deliberately brief.
 */
